...
token_home="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDk0OTA1ODksImlhdCI6MTYwNjg5ODU4OSwic3ViIjoxfQ.HxIP_5b4qFB24BX4IlaNy4T8HsoacG1w4AZ4Rmf3_ig"
...
def login():
    ...
    x = {'subject': "login", 'email': "athmani", 'password': "12345678"}
    body2=json.dumps(x)
